...
# ============================================
print("\n" + "=" * 50 + "\n1. ЗАГРУЗКА И ПЕРВИЧНОЕ ЗНАКОМСТВО\n" + "=" * 50 +
"""\n\nНазвание: Sleep, Screen Time and Stress Analysis
Ссылка: https://www.kaggle.com/datasets/jayjoshi37/sleep-screen-time-and-stress-analysis
Дата доступа: 16.04.2026
Автор: Jay Joshi
Дата создания: март 2026 г""" +
...
plt.suptitle('1.2.1\nРаспределение числовых признаков', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.show()
...
print("Пара 1: Отрицательная корреляция: чем больше экранного времени тем ниже качество сна")
...
sns.barplot(x=stress_corr.values, y=stress_corr.index, palette='RdBu_r')
...
plt.suptitle('Рис.1.2.7 - Boxplot для выявления выбросов', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.show()
...
ax.set_title('Рисунок 10. Сравнение диапазонов признаков (исходные единицы)',
...
- Фильтр 2: Пользователи с вредным образом жизни (много экрана + мало активности)
- Фильтр 3: Молодежь с высоким потреблением кофеина
""")
